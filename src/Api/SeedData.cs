...
public static class SeedData
{
    public static void Initialize(AppDbContext db)
    {
        ...
        db.Products.AddRange(
            ...
            new Product { Id = Guid.NewGuid(), Name = "Storage Upgrade", Description = "Additional 100 GB cloud storage", Price = 9.00m, Status = ProductStatus.Draft, CreatedAt = DateTime.UtcNow }
        );
        db.SaveChanges();
